...
*$C = 0.078$ was back-solved to close the design point*, because no Ariel performance data was
...
reciprocating compressor parameterised to represent the class of the reference machines, not
as a validated reproduction of their specific performance.
...
compressor load. A real CAT G3516LE with an ADEM A3 governor would droop under load; this model
