...
#data-table(
  ...
  (
    ...
    ([Clearance fraction $C = 0.078$ was back-solved to close the design point, not sourced from Ariel performance data],
     [This is the single largest fitted parameter in the model],
     [Any claim of validated fidelity to a real Ariel JGH/4 — this is exactly why the package is framed as a generic three-stage compressor throughout this document]),
