...
#fig("/images/features/fig20_hmi_home_dark_theme_running.png",
  [Compressor Simulator in dark theme, unit running under PLC control: all three
   ...
   psig, ST2 364 psig, ST3 1071 psig), engine at 850 rpm. The connection banner at
   top right ("Connection is closed") is a stale artifact of this particular
   capture, not a normal running state.])
...
evaluate alarms (@intro-background).
